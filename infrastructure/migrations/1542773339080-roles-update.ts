...
export class rolesUpdate1542773339080 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`DROP INDEX "IDX_58d9a963baa485fa0568d1a154" ON "system-user-roles2"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_665ad80184d2a6b26b7bb22962" ON "system-user-roles2"("contextEntity") `);
        await queryRunner.query(`CREATE INDEX "IDX_e94a5492c62b6baf1139583394" ON "system-user-roles2"("contextScope") `);
        await queryRunner.query(`CREATE INDEX "IDX_58d9a963baa485fa0568d1a154" ON "system-user-roles2"("userGuid") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "REL_26ef62bab7edede12c4898a3ee" ON "system-users"("profileGuid") WHERE ([profileGuid] IS NOT NULL)`);
        await queryRunner.query(`CREATE INDEX "IDX_797abf10a90a3306603fbf46bc" ON "system-permissions"("scope") `);
    }
