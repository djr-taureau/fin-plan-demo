...
import { AuthenticatedGuard, HttpAuthTokenInterceptor } from '@lifeworks/authentication';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild([
      { path: '', pathMatch: 'full', component: ActivityPageComponent, canActivate: [AuthenticatedGuard] }
    ]),
  ...
  providers: [
    ActivityLogAPIService, ActivityLogService, ActivityLogEffects,
