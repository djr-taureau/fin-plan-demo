...
describe('AuthService', () => {
  const provider = jasmine.createSpyObj<AuthProvider>('provider', ['login', 'logout', 'isAuthenticated',]);
  ...
  it('should call provider functions', inject([AuthService], (service: AuthService) => {
